        ...
        <ResponsiveContainer>
          <VStack spacing={[4, 6, 10, 12]} alignItems='flex-start' justifyContent='flex-start'>
            <VStack alignItems='flex-start'>
              ...
              <Text>
                Es besteht keine Kapitalbeteiligung von 10% oder mehr an einem Versicherer. Es ist kein Versicherer zu
                10% oder mehr an dem Vermittler beteiligt.
              </Text>
              <Text>
            ...
            <VStack alignItems={'flex-start'}>
              ...
              <VStack alignItems={'flex-start'}>
                <Text>
                  ...
                  Google verarbeiten. Google wird in keinem Fall Ihre IP-Adresse mit anderen Daten von Google in
                  Verbindung bringen.
                </Text>
                <Text>
            ...
            <VStack alignItems={'flex-start'}>
              ...
              <VStack alignItems={'flex-start'}>
                ...
                <Text>
                  ...
                  diesbezüglichen Rechte und Einstellungsmöglichkeiten zum Schutz Ihrer Privatssphäre entnehmen Sie
                ...
                <Text>
                  Wenn Sie Facebookmitglied sind und nicht möchten, dass Facebook über unseren Internetauftritt Daten
                  über Sie sammelt und mit Ihren bei Facebook gespeicherten Daten verknüpft, müssen Sie sich vor Ihrem
                  Besuch unseres Internetauftritts bei Facebook ausloggen. Ebenfalls ist es möglich,
                  Facebook-Social-Plugins mit Add-ons für Ihren Browser zu blocken.
                </Text>
              </VStack>
            </VStack>
            ...
            <VStack alignItems={'flex-start'}>
              ...
              <VStack alignItems={'flex-start'}>
                <Text>
                  ...
                  durch die Twitter Inc., 795 Folsom St., Suite 600, San Francisco, CA 94107, USA. Durch das Benutzen

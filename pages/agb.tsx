        ...
        <ResponsiveContainer>
          <VStack spacing={[4, 6, 10, 12]} alignItems='flex-start' justifyContent='flex-start'>
            ...
            <VStack alignItems={'flex-start'}>
              ...
              <VStack alignItems={'flex-start'}>
                <Text>
                  ...
                  zwischen Interessenten (nachfolgend „Kunde“) und der SIGURON GmbH Fürstenrieder Str. 279a 81377
                  München. Eingetragen im Handelsregister Registergericht München HRB 171981(nachfolgend „SIGURON“)
                  genannt.
                </Text>
                <Text>
            ...
            <VStack alignItems={'flex-start'}>
              ...
              <VStack alignItems={'flex-start'}>
                <Text>
                  2.1. Die Tätigkeit der SIGURON beschränkt sich ausschließlich auf die Vermittlung von
                  Vertragsschlüssen im Bereich des Darlehens- und Versicherungsgeschäftes. SIGURON erbringt keine
                  Beratungs-, insbesondere Rechtsberatungsdienstleistungen. Die SIGURON wird die von dem Kunden
                  mitgeteilten Daten an geeignete Kooperationspartner mit dem Ziel der Vermittlung eines
                  Vertragsschlusses zwischen den Kooperationspartner und dem Kunden weiterleiten. Der Kunde erklärt sich
                  ausdrücklich damit einverstanden. SIGURON wird die vom Kunden mitgeteilten Angaben hinsichtlich des
                  Finanzierungsobjektes und seiner persönlichen und wirtschaftlichen Verhältnisse nicht prüfen. Die
                  Prüfung und Bewertung obliegt ausschließlich den angesprochenen Kooperationspartnern als mögliche
            ...
            <VStack alignItems={'flex-start'}>
              ...
              <VStack alignItems={'flex-start'}>
                <Text>
                  3.1. SIGURON gibt dem Kunden die Möglichkeit, die zur Vermittlung von Darlehen und damit
                  einhergehenden notwendigen Daten und Unterlagen über die Europace-Martplatz und/oder der Prohyp
                  Plattform einzugeben. SIGURON nutzt für die Zinsberechnung den Europace-Marktplatz und/oder die Prohyp
                  Plattform (siehe Ziffer 4). Die Daten und Unterlagen des Kunden werden zur reinen Zinsberechnung nicht
                  an die Finanzierungspartner weitergeleitet. Dies geschieht erst nach einem Beratungsgespräch mit dem
              ...
              <VStack alignItems={'flex-start'}>
                ...
                <Text>
                  Diese Leistungen dienen ausschließlich der Erleichterung einer selbständigen Entscheidung des Kunden,
                  ob und welches Darlehen er über SIGURON vermittelt bekommen und abschließen möchte.
                </Text>
                <Text>
              ...
              <VStack alignItems={'flex-start'}>
                <Text>
                  ...
                  Finanzierungsspezialisten kontaktieren oder den im Folgenden beschriebenen Dokumenten-Upload
                  verwenden.
                </Text>
                <Text>
                  Der Service ermöglicht es den Nutzern ferner, bei den SIGURON Vergleichen zusätzlich Zeit zu sparen,
                  da die bereits einmal eingegebenen Informationen mit einem einfachen Klick komfortabel auch für einen
                  neuen Vergleich genutzt werden können. Wichtig ist, dass die SIGURON GmbH, mit Ausnahme von gewissen
                  Stammdaten, die in den Nutzungsbedingungen explizit genannt sind, keine in diesem Zusammenhang
                  stehenden Daten speichert, sondern lediglich jedes Mal mit Einloggen in das Kundenkonto eine temporäre
                  und dynamische Sichtweise auf die Aktivitäten eines Kundenkontonutzers bei den jeweiligen Unternehmen
            ...
            <VStack alignItems={'flex-start'}>
              ...
              <VStack alignItems={'flex-start'}>
                <Text>
                  ...
                  Angaben macht, ist SIGURON berechtigt, die Anfrage unbearbeitet zu lassen. Für den Fall der
                  Übermittlung von vorsätzlich falschen oder unwahren persönlichen Daten durch den Kunden behält sich
                  die SIGURON vor, ihn von der Inanspruchnahme der angebotenen bzw. zu Verfügung gestellten
                  Vermittlungsleistungen auszuschließen und Ersatz für dadurch eingetretene Schäden zu verlangen.
                </Text>
                <Text>
                  5.2. Der Kunde ist verpflichtet, vom Finanzierungspartner erhaltene Vertragsunterlagen unverzüglich
                  auf Korrektheit zu überprüfen und bei Fehlern SIGURON entsprechend zu informieren.
                </Text>
                <Text>
            ...
            <VStack alignItems={'flex-start'}>
              ...
              <VStack alignItems={'flex-start'}>
                ...
                <Text>
                  6.2. SIGURON erhält ausschließlich im Falle einer erfolgreichen Vermittlung eines Darlehensvertrags
                  eine Provision von dem jeweiligen Finanzierungspartner. Die Provisionshöhe kann vom jeweiligen Produkt
                  und dem Finanzierungspartner abhängen.
                </Text>
              </VStack>
            </VStack>
            ...
            <VStack alignItems={'flex-start'}>
              ...
              <VStack alignItems={'flex-start'}>
                <Text>
                  ...
                  Richtigkeit bemüht. Die leistungs- bzw. produktbezogenen Informationen, insbesondere zu
                  Leistungsumfang, Zinssätzen und Konditionen, durch SIGURON beruhen auf den Angaben der jeweiligen
                  Finanzierungspartner dem Europace-Marktplatz und/oder der Prohyp Plattform. Eine Haftung von SIGURON
                  für die Aktualität, Vollständigkeit und Richtigkeit der dargestellten Angebote ist vorbehaltlich
                  Ziffer 8.2 ausgeschlossen.
                </Text>
                <Text>
                  ...
                  ermöglicht und auf deren Einhaltung der Kunde regelmäßig vertraut und vertrauen darf. Im Übrigen
                  haftet SIGURON nicht.
                </Text>
              </VStack>
            </VStack>
            ...
            <VStack alignItems={'flex-start'}>
              ...
              <VStack alignItems={'flex-start'}>
                ...
                <Text>
                  9.2. Sollten Bestimmungen dieser AGB unwirksam oder undurchführbar sein oder werden oder sollte sich
                  in diesen AGB eine Lücke herausstellen, soll hierdurch die Gültigkeit der übrigen Bestimmungen nicht
                  berührt werden.
                </Text>
                <Text>
            ...
            <VStack alignItems={'flex-start'}>
              ...
              <VStack alignItems={'flex-start'}>
                <Text>
                  ...
                  Abschnitt 2 aufgeführten Informationen auf einem dauerhaften Datenträger (z. B. Brief, Telefax,
                  E-Mail) erhalten haben. Zur Wahrung der Widerrufsfrist genügt die rechtzeitige Absendung des
                  Widerrufs, wenn die Erklärung auf einem dauerhaften Datenträger erfolgt. Der Widerruf ist zu richten
                  an: SIGURON Vergleichsportal Baufinanzierung GmbH, Arnulfstraße 19, 80335 München, E-Mail:
                ...
                <Text>
                  ...
                  <br />
                  Im Fall eines wirksamen Widerrufs sind die beiderseits empfangenen Leistungen zurückzugewähren. Sie
                  sind zur Zahlung von Wertersatz für die bis zum Widerruf erbrachte Dienstleistung verpflichtet, wenn
                  Sie vor Abgabe Ihrer Vertragserklärung auf diese Rechtsfolge hingewiesen wurden und ausdrücklich
                  zugestimmt haben, dass vor dem Ende der Widerrufsfrist mit der Ausführung der Gegenleistung begonnen
                  werden kann. Besteht eine Verpflichtung zur Zahlung von Wertersatz, kann dies dazu führen, dass Sie
                  die vertraglichen Zahlungsverpflichtungen für den Zeitraum bis zum Widerruf dennoch erfüllen müssen.
                  ...
                  Erstattung von Zahlungen müssen innerhalb von 30 Tagen erfüllt werden. Diese Frist beginnt für Sie mit
                ...
                <Text>
                  ...
                  mehr gebunden, wenn der zusammenhängende Vertrag eine Leistung betrifft, die von uns oder einem

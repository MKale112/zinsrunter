      ...
      <ResponsiveContainer py={[6, 6]}>
        <VStack spacing={16}>
          <VStack spacing={{ base: 4, md: 6 }}>
            ...
            <Text textAlign='center'>
              Rechnen Sie ganz einfach aus wie hoch in Ihrem Fall die Notar- sowie Grundbuchkosten ausfallen.
            </Text>
          </VStack>
        </VStack>
        <VStack spacing={16} my={[5, 6]} px={[2, 5]} bgColor={'white'}>
          <iframe
            ...
            width={`100%`}
            height={`100%`}
            src='https://www.ehyp.de/ehyp/servlet/ehyp?view=b2bCalculator&calltype=b2bexternal&calc=showGrundbuchRechner1&cst.id.cryptUltd=43533337cqjp-7j1npg5r655hu98i5yl2kf92c57&STYLE=ehypPublic'
          ></iframe>
        </VStack>
      </ResponsiveContainer>
